import N, { useEffect, useState, useContext, useCallback, Component } from 'react';
...
var J = function (r) {
  ...
  function i() {
    return _classCallCheck(this, i), a.apply(this, arguments);
  }
  ...
  return _createClass(i, [{
    ...
    value: function (e) {
      var t = this;
      return Observable.create(function (n) {
        t.datasource[e] ? n.next(t.datasource[e]) : n.error(new Error('Could not find activity with ID "'.concat(e, '"'))), n.complete();
      });
    }
  }]), i;
}();
...
var te = function (r) {
  ...
  return _createClass(i, [{
    ...
    value: function () {
      var e = this;
      return Observable.create(function (t) {
        t.next({
          ID: e.ID,
          type: "JOIN",
          text: "Join meeting",
...
var ie = function (r) {
  ...
  return _createClass(o, [{
    key: "action",
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.joinMeeting(t);
    ...
    value: function (e) {
      var t = this;
      return this.adapter.getMeeting(e).pipe(map(function (e) {
        return {
          hint: (e.localAudio.stream ? "Unmuted, " : "Muted, ") + (e.localVideo.stream ? "video on" : "video off"),
          state: "NOT_JOINED" === e.state ? z : B
        };
      }), distinctUntilChanged(function (e, t) {
        return e.hint === t.hint && e.state === t.state;
      }), map(function (e) {
        var n = e.hint,
            r = e.state;
        return {
...
var se = function (r) {
  ...
  function s() {
    return _classCallCheck(this, s), i.apply(this, arguments);
  }
  ...
  return _createClass(s, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.leaveMeeting(t);
  ...
  return _createClass(o, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.toggleMuteAudio(t);
    ...
    value: function (e) {
      ...
      return this.adapter.getMeeting(e).pipe(map(function (e) {
        var t;
        return !(null === (t = e.localAudio) || void 0 === t || !t.stream);
      }), distinctUntilChanged(), map(function (e) {
        return e ? t : n;
      }));
    }
  }]), o;
  ...
  return _createClass(o, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.toggleMuteVideo(t);
  ...
  return _createClass(o, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.toggleRoster(t);
  ...
  return _createClass(o, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.toggleSettings(t);
  ...
  return _createClass(o, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.handleLocalShare(t);
...
var be = function (r) {
  ...
  function l() {
    return _classCallCheck(this, l), i.apply(this, arguments);
  }

  return _createClass(l, [{
    key: "action",
    value: (a = _asyncToGenerator(regenerator.mark(function e(t, n) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.switchCamera(t, n);
    ...
    value: function (e) {
      var t = this,
          n = this.adapter.getMeeting(e).pipe(first(), concatMap(function () {
        return defer(function () {
          return t.adapter.getAvailableDevices(e, "videoinput");
        });
      })),
        ...
        }), n.complete()) : n.error(new Error('Could not find meeting with ID "'.concat(e, '" to add a switch camera control')));
      }),
        ...
        return n.pipe(map(function (t) {
          return Ce(Ce({}, e), {}, {
            options: (t || []) && t.map(function (e) {
              return {
                value: e.deviceId,
                label: e.label || "Camera-".concat(e.deviceId),
                camera: e
              };
            })
          });
          ...
          i = a.pipe(concatMap(function (n) {
        return t.adapter.getMeeting(e).pipe(map(function (e) {
          return e.cameraID;
        }), distinctUntilChanged(), map(function (e) {
          return Ce(Ce({}, n), {}, {
            selected: e
      ...
      return concat(r, a, i).pipe(distinctUntilChanged(function (e, t) {
        return e.selected === t.selected && e.options === t.options;
      }));
    }
  }]), l;
}();
  ...
  return _createClass(l, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t, n) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.switchMicrophone(t, n);
    ...
    value: function (e) {
      var t = this,
          n = this.adapter.getMeeting(e).pipe(first(), concatMap(function () {
        return defer(function () {
          return t.adapter.getAvailableDevices(e, "audioinput");
        });
      })),
          r = new Observable(function (n) {
        t.adapter.fetchMeeting(e) ? (n.next({
        ...
        }), n.complete()) : n.error(new Error('Could not find meeting with ID "'.concat(e, '" to add switch microphone control')));
      }),
          a = r.pipe(concatMap(function (e) {
        return n.pipe(map(function (t) {
          return xe(xe({}, e), {}, {
            options: (t || []) && t.map(function (e) {
              return {
                value: e.deviceId,
                label: e.label || "Microphone-".concat(e.deviceId),
                microphone: e
              };
            })
          });
  ...
  !function () {
    ...
    function n() {
      for (var e = [], r = 0; r < arguments.length; r++) {
        ...
        if (a) {
          var i = typeof a;
          if ("string" === i || "number" === i) e.push(a);else if (Array.isArray(a) && a.length) {
            var o = n.apply(null, a);
            o && e.push(o);
          } else if ("object" === i) for (var s in a) t.call(a, s) && a[s] && e.push(s);
        }
      }
...
function Ie(e, t, n) {
  ...
  return [Me(function (e) {
    ...
    return e;
  }((_defineProperty(r = {}, "".concat("wxc", "-").concat(e), !0), _defineProperty(r, t, !!t), r), Object.fromEntries(Object.entries(n || {}).map(function (t) {
    var n = _slicedToArray(t, 2),
        r = n[0],
        a = n[1];
    return ["".concat("wxc", "-").concat(e, "--").concat(r), a];
  })))), function (t) {
    return "".concat("wxc", "-").concat(e, "__").concat(t);
  }];
}

var Pe = !!document.createElement("audio").setSinkId;
  ...
  return _createClass(l, [{
    ...
    value: (a = _asyncToGenerator(regenerator.mark(function e(t, n) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.adapter.switchSpeaker(t, n);
    ...
    value: function (e) {
      var t = this,
          n = defer(function () {
        return t.adapter.getAvailableDevices(e, "audiooutput");
      }).pipe(map(function (e) {
        ...
        t.adapter.fetchMeeting(e) ? (n.next({
          ID: t.ID,
          type: "MULTISELECT",
          tooltip: Pe ? "Speaker Devices" : "The current browser does not support changing speakers",
          noOptionsMessage: "No available speakers",
          options: null,
          selected: null,
          hint: 'Use arrow keys to navigate between speaker options and hit "Enter" to select.'
        }), n.complete()) : n.error(new Error('Could not find meeting with ID "'.concat(e, '" to add switch speaker control')));
      }),
          a = r.pipe(concatMap(function (e) {
        return n.pipe(map(function (t) {
          return Re(Re({}, e), {}, {
...
var He = {
  ...
  function R(t) {
    var n, r;
    return _classCallCheck(this, R), (r = S.call(this, t)).meetingControls = (_defineProperty(n = {}, "mute-audio", new le(_assertThisInitialized(r), "mute-audio")), _defineProperty(n, "mute-video", new me(_assertThisInitialized(r), "mute-video")), _defineProperty(n, "share-screen", new ge(_assertThisInitialized(r), "share-screen")), _defineProperty(n, "join-meeting", new ie(_assertThisInitialized(r), "join-meeting")), _defineProperty(n, "leave-meeting", new se(_assertThisInitialized(r), "leave-meeting")), _defineProperty(n, "disabled-mute-audio", new re(_assertThisInitialized(r), "disabled-mute-audio")), _defineProperty(n, "disabled-join-meeting", new te(_assertThisInitialized(r), "disabled-join-meeting")), _defineProperty(n, "member-roster", new de(_assertThisInitialized(r), "member-roster")), _defineProperty(n, "settings", new he(_assertThisInitialized(r), "settings")), _defineProperty(n, "switch-camera", new be(_assertThisInitialized(r), "switch-camera")), _defineProperty(n, "switch-microphone", new ke(_assertThisInitialized(r), "switch-microphone")), _defineProperty(n, "switch-speaker", new ze(_assertThisInitialized(r), "switch-speaker")), n), r.displayStreamPromise = null, r;
  }
  ...
  return _createClass(R, [{
    ...
    value: function (e) {
      ...
      return Observable.create(function (n) {
        e ? (n.next(Be(Be({}, He), {}, {
          ID: e
        })), n.next(t.datasource[e])) : n.error(new Error('Could not create meeting at destination "'.concat(e, '"'))), n.complete();
      });
    }
  }, {
    key: "getMeeting",
    value: function (e) {
      var t = this,
          n = Observable.create(function () {
        var n = _asyncToGenerator(regenerator.mark(function n(r) {
          var a, i, o, s, c, l, u, p, d;
          return regenerator.wrap(function (n) {
            for (;;) switch (n.prev = n.next) {
              ...
              case 4:
                ...
                if ((a = t.fetchMeeting(e)).remoteVideo instanceof MediaStream && (a.remoteVideo = t.getVideoStream()), a.remoteShare instanceof MediaStream && (a.remoteShare = t.getShareStream()), !t.emptyStream(a.localVideo.stream)) {
                  n.next = 18;
                  break;
                }

                return n.next = 11, t.getStream({
                  video: !0,
                  audio: !1
                });

              case 11:
                i = n.sent, o = i.stream, s = i.perm, c = i.deviceId, a.localVideo.stream = o, a.localVideo.permission = s, a.cameraID = c;

              case 18:
                if (!t.emptyStream(a.localAudio.stream)) {
                  n.next = 28;
                  break;
                }

                return n.next = 21, t.getStream({
                  video: !1,
                  audio: !0
                });

              case 21:
                l = n.sent, u = l.stream, p = l.perm, d = l.deviceId, a.localAudio.stream = u, a.localAudio.permission = p, a.microphoneID = d;

              case 28:
                if (!t.displayStreamPromise) {
                  n.next = 31;
                  break;
                }

                return n.next = 31, t.displayStreamPromise;

              case 31:
                if (!t.emptyStream(a.localShare.stream)) {
                  n.next = 37;
                  break;
                }

                return t.displayStreamPromise = t.getDisplayStream(), n.next = 35, t.displayStreamPromise;

              case 35:
                a.localShare.stream = n.sent, t.displayStreamPromise = null;
              ...
              case 40:
                r.error(new Error('Could not find meeting with ID "'.concat(e, '"')));
        ...
        return function (e) {
          ...
          r = fromEvent(document, "meeting:update").pipe(filter(function (t) {
        return t.detail.ID === e;
      }), map(function (e) {
        return Be({}, e.detail);
      }));
      return concat(n, r).pipe(takeWhile(function (e) {
        return e.state !== q;
      }, !0));
    }
  }, {
    key: "joinMeeting",
    value: (P = _asyncToGenerator(regenerator.mark(function e(t) {
      var n,
          r = this,
          a = arguments;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return n = a.length > 1 && void 0 !== a[1] ? a[1] : {}, e.next = 3, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(t) {
                var a;
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      if (!t.password || n.password || n.hostKey) {
                        e.next = 4;
                        break;
                      }
                    ...
                    case 4:
                      if (!t.password || !n.password || n.password === t.password) {
                        e.next = 8;
                        break;
                      }
                    ...
                    case 8:
                      if (!t.hostKey || !n.hostKey || n.hostKey === t.hostKey) {
                        e.next = 12;
                        break;
                      }
                    ...
                    case 12:
                      return e.next = 14, r.getStream({
                        video: !0,
                        audio: !1
                      });

                    case 14:
                      return e.t0 = e.sent.stream, e.next = 17, r.getStream({
                        video: !1,
                        audio: !0
                      });

                    case 17:
                      e.t1 = e.sent.stream, e.t2 = H, a = {
                        remoteVideo: e.t0,
                        remoteAudio: e.t1,
                        state: e.t2
                      };
    ...
    value: (I = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, _asyncToGenerator(regenerator.mark(function e() {
              return regenerator.wrap(function (e) {
                for (;;) switch (e.prev = e.next) {
                  case 0:
    ...
    key: "leaveMeeting",
    value: (L = _asyncToGenerator(regenerator.mark(function e(t) {
      var n = this;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(t) {
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      return n.stopStream(t.localVideo.stream), n.stopStream(t.localAudio.stream), e.abrupt("return", {
                        remoteVideo: null,
                        remoteAudio: null,
                        state: q
                      });
    ...
    key: "getStream",
    value: (M = _asyncToGenerator(regenerator.mark(function e(t) {
      var n, r, a, i, o, s, c;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.prev = 0, e.next = 3, navigator.mediaDevices.getUserMedia(t);

          case 3:
            return o = e.sent, e.next = 6, this.getAvailableDevices();

          case 6:
            s = e.sent, c = o.getTracks()[0].label, r = null === (i = s.find(function (e) {
              return e.label === c;
            })) || void 0 === i ? void 0 : i.deviceId, t.video && (n = new MediaStream([o.getVideoTracks()[0]])), t.audio && (n = new MediaStream([o.getAudioTracks()[0]])), a = "ALLOWED", e.next = 18;
            break;

          case 14:
            e.prev = 14, e.t0 = e.catch(0), console.error("Meetings JSON adapter can not display the local user stream", e.t0), a = e.t0 instanceof DOMException ? "NotAllowedError" === e.t0.name ? "Permission dismissed" === e.t0.message ? "DISMISSED" : "Permission denied by system" === e.t0.message ? "DISABLED" : "DENIED" : "NotReadableError" === e.t0.name ? "DISABLED" : "ERROR" : "ERROR";
    ...
    value: (D = _asyncToGenerator(regenerator.mark(function e() {
      var t;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return t = null, e.prev = 1, e.next = 4, navigator.mediaDevices.getDisplayMedia();
          ...
          case 7:
            e.prev = 7, e.t0 = e.catch(1), console.error("Meetings JSON adapter can not display the local user sharing stream", e.t0);
    ...
    value: (O = _asyncToGenerator(regenerator.mark(function e(t, n) {
      var r, a;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            if (r = this.datasource[t], a = [], "videoinput" === n && ["ERROR", "DISABLED"].includes(r.localVideo.permission) || "audioinput" === n && ["ERROR", "DISABLED"].includes(r.localAudio.permission)) {
              e.next = 13;
              break;
            }

            return e.prev = 3, e.next = 6, navigator.mediaDevices.enumerateDevices();

          case 6:
            a = (a = e.sent).filter(function (e) {
              return !n || e.kind === n && e.deviceId;
            }), e.next = 13;
            break;

          case 10:
            e.prev = 10, e.t0 = e.catch(3), console.error("Meetings JSON adapter can not enumerate media devices", e.t0);
    ...
    value: function (e) {
      var t = document.getElementById(e),
          n = new MediaStream();
      return t && t.captureStream ? n = t.captureStream() : t && t.mozCaptureStream && (n = t.mozCaptureStream()), n;
    }
  }, {
    key: "getVideoStream",
    value: function () {
    ...
    key: "stopStream",
    value: function (e) {
      null != e && e.getTracks && e.getTracks().forEach(function (e) {
        return e.stop();
      });
    }
  }, {
    key: "emptyStream",
    value: function (e) {
      return e instanceof MediaStream && 0 === e.getTracks().length;
    }
  }, {
    key: "toggleMuteAudio",
    value: (k = _asyncToGenerator(regenerator.mark(function e(t) {
      var n = this;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(t) {
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      if (n.stopStream(t.localAudio.stream), !t.localAudio.stream) {
                        e.next = 5;
                        break;
                      }
            ...
            return e.next = 2, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(t) {
                ...
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      if (n.stopStream(t.localVideo.stream), null === (r = t.localVideo) || void 0 === r || !r.stream) {
                        e.next = 5;
                        break;
                      }
    ...
    key: "handleLocalShare",
    value: (x = _asyncToGenerator(regenerator.mark(function e(t) {
      var n = this;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(r) {
                var a, i;
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      if (a = {}, !r.localShare.stream) {
                        e.next = 6;
                        break;
                      }

                      n.stopStream(r.localShare.stream), a = {
                        localShare: {
                          stream: null
                        }
                      }, e.next = 10;
                    ...
                    case 6:
                      return e.next = 8, n.getDisplayStream();

                    case 8:
                      null != (i = e.sent) && i.getVideoTracks && (i.getVideoTracks()[0].onended = function () {
                        n.handleLocalShare(t);
                      }, a = {
                        remoteShare: null,
                        localShare: {
                          stream: i
    ...
    key: "toggleRoster",
    value: (E = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, function () {
    ...
    key: "toggleSettings",
    value: (b = _asyncToGenerator(regenerator.mark(function e(t) {
      var n = this;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
                ...
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      ...
                      r.settings.preview.video = t.localVideo.stream.clone(), e.next = 14;
                      break;

                    case 7:
                      return e.next = 9, n.getStream({
                        video: {
                          deviceId: {
                            exact: t.cameraID
                          }
                    ...
                    case 9:
                      a = e.sent, i = a.stream, o = a.deviceId, r.settings.preview.video = i, r.cameraID = o;

                    case 14:
                      if (!t.localAudio.stream) {
                        e.next = 18;
                        break;
                      }

                      r.settings.preview.audio = t.localAudio.stream.clone(), e.next = 25;
                      break;

                    case 18:
                      return e.next = 20, n.getStream({
                        audio: {
                          deviceId: {
                    ...
                    case 20:
                      s = e.sent, c = s.stream, l = s.deviceId, r.settings.preview.microphoneID = c, r.microphoneID = l;
                    ...
                    case 27:
                      n.stopStream(t.localVideo.stream), n.stopStream(t.localAudio.stream), r = {
                        settings: {
                          visible: !1
                        },
                        localVideo: {
                          stream: t.localVideo.stream && t.settings.preview.video
                        },
                        localAudio: {
                          stream: t.localAudio.stream && t.settings.preview.audio
                        }
                      };
    ...
    key: "switchCamera",
    value: (y = _asyncToGenerator(regenerator.mark(function e(t, n) {
      var r = this;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(t) {
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      return r.stopStream(t.settings.preview.video), e.next = 3, r.getStream({
                        video: {
                          deviceId: {
                            exact: n
                          }
                    ...
                    case 3:
                      return e.t0 = e.sent.stream, e.t1 = {
                        video: e.t0
                      }, e.t2 = {
                        preview: e.t1
                      }, e.t3 = n, e.abrupt("return", {
                        settings: e.t2,
                        cameraID: e.t3
                      });
    ...
    value: (g = _asyncToGenerator(regenerator.mark(function e(t, n) {
      var r = this;
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, function () {
              var e = _asyncToGenerator(regenerator.mark(function e(t) {
                return regenerator.wrap(function (e) {
                  for (;;) switch (e.prev = e.next) {
                    case 0:
                      return r.stopStream(t.settings.preview.audio), e.next = 3, r.getStream({
                        audio: {
                          deviceId: {
                            exact: n
                          }
    ...
    key: "switchSpeaker",
    value: (v = _asyncToGenerator(regenerator.mark(function e(t, n) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, _asyncToGenerator(regenerator.mark(function e() {
    ...
    key: "clearPasswordRequiredFlag",
    value: (u = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, _asyncToGenerator(regenerator.mark(function e() {
    ...
    key: "clearInvalidPasswordFlag",
    value: (s = _asyncToGenerator(regenerator.mark(function e(t) {
      return regenerator.wrap(function (e) {
        for (;;) switch (e.prev = e.next) {
          case 0:
            return e.next = 2, this.updateMeeting(t, _asyncToGenerator(regenerator.mark(function e() {
...
var Ze = function (r) {
  ...
  return _createClass(i, [{
    ...
    value: function (e, t) {
      var n = this;
      return Observable.create(function (r) {
        var a = Object.values(n.datasource).find(function (n) {
          return n.destinationID === e && n.destinationType === t;
        });
        a ? r.next(a.members) : r.error(new Error('Could not find members for destination "'.concat(e, '"'))), r.complete();
      });
    }
  }]), i;
}();
  ...
  return _createClass(i, [{
    ...
    value: function (e) {
      ...
      return new Observable(function (n) {
        var r = Object.values(t.datasource).find(function (t) {
          return t.ID === e;
        });
        r ? (n.next(r), n.complete()) : n.error(new Error('Could not find any organization with ID "'.concat(e, '"')));
      });
    }
  }]), i;
}();
...
var Ge = function (r) {
  ...
  return _createClass(i, [{
    ...
    value: function () {
      var e = this;
      return Observable.create(function (t) {
        t.next(e.datasource.user1), t.complete();
      });
    }
  }, {
    key: "getPerson",
    value: function (e) {
      var t = this;
      return Observable.create(function (n) {
        t.datasource[e] ? n.next(t.datasource[e]) : n.error(new Error('Could not find person with ID "'.concat(e, '"'))), n.complete();
      });
    }
  }]), i;
}();
...
var Xe = function (r) {
  ...
  function i(t) {
    var n;
    return _classCallCheck(this, i), (n = a.call(this, t)).dataChunkSize = 4, n.lastDataIndex = {}, n;
  }
  ...
  return _createClass(i, [{
    ...
    value: function (e) {
      var t = this;
      return Observable.create(function (n) {
        t.datasource[e] ? n.next(t.datasource[e]) : n.error(new Error('Could not find room with ID "'.concat(e, '"'))), n.complete();
      });
    }
  }, {
    ...
    value: function (e) {
      var t = this;
      return Observable.create(function (n) {
        var r = t.datasource["".concat(e, "-activities")] ? t.datasource["".concat(e, "-activities")] : [];
        n.next(r), n.complete();
      });
    }
  }, {
    key: "getPreviousRoomActivities",
    value: function (e) {
      var t = this;
      return Observable.create(function (n) {
        if ("".concat(e, "-previous-activities") in t.datasource) {
          if (t.hasMoreActivities(e)) {
            var r,
                a = t.lastDataIndex[e] ? t.lastDataIndex[e] : 0,
                i = a + t.dataChunkSize;
            r = t.datasource["".concat(e, "-previous-activities")].slice(a, i), t.lastDataIndex[e] = i, n.next(r);
          } else n.complete();
        } else {
          var o = "Could not find activities for room ".concat(e, ". Make sure room ID is valid!");
          n.error(new Error(o));
        }
      });
    }
  }, {
    key: "hasMoreActivities",
    value: function (e) {
      this.lastDataIndex[e] = this.lastDataIndex[e] ? this.lastDataIndex[e] : 0;
      var t = !1;
      return "".concat(e, "-previous-activities") in this.datasource && (t = this.lastDataIndex[e] < this.datasource["".concat(e, "-previous-activities")].length), t;
    }
  }]), i;
}();
...
(function (r) {
  ...
  function i(t) {
    var n;
    return _classCallCheck(this, i), (n = a.call(this, t)).activitiesAdapter = new J(t.activities), n.meetingsAdapter = new qe(t.meetings), n.membershipsAdapter = new Ze(t.memberships), n.organizationsAdapter = new We(t.organizations), n.peopleAdapter = new Ge(t.people), n.roomsAdapter = new Xe(t.rooms), n;
  }
...
function nt(e) {
  var t = e.size,
      n = e.className,
      r = e.style,
      a = Ie("audio-microphone-muted-icon", n),
      i = _slicedToArray(a, 1)[0];
  return N.createElement("svg", {
    width: t,
    height: t,
...
var Pt = {
  ...
  "more-adr": yt,
  "participant-list": Ct,
  "participant-list-filled": wt,
  "pto-presence": bt,
  "quiet-hours-presence": Et,
  "recents-presence": xt,
  settings: kt,
  "share-screen-presence-stroke": Dt,
  "share-screen-filled": Ot,
  "show-password": Mt,
  unread: Lt,
  warning: It,
  "waiting-for-host": Tt
...
function St(e) {
  var t = e.name,
      ...
      l = s[1],
      u = Pt[c];
  return u || (console.error("".concat(c, ' icon is not defined. Available icons are "').concat(Object.keys(Pt).join(", "), '".')), u = "span"), N.createElement(u, {
    size: n || l && Number(l),
    className: r,
    style: a,
    ariaLabel: i
...
var Bt,
    Vt = [],
    Ht = "ResizeObserver loop completed with undelivered notifications.";
!function (e) {
...
var qt,
  ...
  return !!(r && e instanceof r.Element);
    ...
    _t = /auto|scroll/,
    Xt = /^tb|vertical/,
    Kt = /msie|trident/i.test(Yt.navigator && Yt.navigator.userAgent),
    Jt = function (e) {
  ...
  borderBoxSize: Qt(),
  contentBoxSize: Qt(),
  contentRect: new Ut(0, 0, 0, 0)
}),
    en = function (e, t) {
  if (void 0 === t && (t = !1), Gt.has(e) && !t) return Gt.get(e);
  if (Ft(e)) return Gt.set(e, $t), $t;

  var n = getComputedStyle(e),
      r = Zt(e) && e.ownerSVGElement && e.getBBox(),
      a = !Kt && "border-box" === n.boxSizing,
      i = Xt.test(n.writingMode || ""),
      o = !r && _t.test(n.overflowY || ""),
      s = !r && _t.test(n.overflowX || ""),
  ...
  Vt.forEach(function (n) {
    if (0 !== n.activeTargets.length) {
      ...
      n.activeTargets.forEach(function (t) {
        var n = new nn(t.target),
            a = rn(t.target);
        r.push(n), t.lastReportedSize = tn(t.target, t.observedBox), a < e && (e = a);
      }), t.push(function () {
  ...
  Vt.forEach(function (t) {
    t.activeTargets.splice(0, t.activeTargets.length), t.skippedTargets.splice(0, t.skippedTargets.length), t.observationTargets.forEach(function (n) {
      n.isActive() && (rn(n.target) > e ? t.activeTargets.push(n) : t.skippedTargets.push(n));
    });
  });
},
    sn = function () {
  ...
  return Vt.some(function (e) {
    ...
    message: Ht
  }) : ((e = document.createEvent("Event")).initEvent("error", !1, !1), e.message = Ht), window.dispatchEvent(e)), t > 0;
},
    cn = [],
    ln = function (e) {
  if (!qt) {
  ...
  subtree: !0
    ...
    pn = ["resize", "load", "transitionend", "animationend", "animationstart", "animationiteration", "keyup", "keydown", "mouseup", "mousedown", "mouseover", "mouseout", "blur", "focus"],
    dn = function (e) {
  ...
  return e.prototype.run = function (e) {
    ...
    var e = this,
        t = function () {
      return e.observer && e.observer.observe(document.body, mn);
    };

    document.body ? t() : Yt.addEventListener("DOMContentLoaded", t);
  }, e.prototype.start = function () {
    var e = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), pn.forEach(function (t) {
      return Yt.addEventListener(t, e.listener, !0);
    }));
  }, e.prototype.stop = function () {
    var e = this;
    this.stopped || (this.observer && this.observer.disconnect(), pn.forEach(function (t) {
      return Yt.removeEventListener(t, e.listener, !0);
    }), this.stopped = !0);
  }, e;
}())(),
    vn = function (e) {
  !un && e > 0 && hn.start(), !(un += e) && hn.stop();
},
    gn = function () {
  function e(e, t) {
    this.target = e, this.observedBox = t || Bt.CONTENT_BOX, this.lastReportedSize = {
      inlineSize: 0,
      blockSize: 0
    };
  }
  ...
  return e.prototype.isActive = function () {
    var e,
        t = tn(this.target, this.observedBox, !0);
    return e = this.target, Zt(e) || function (e) {
      switch (e.tagName) {
        case "INPUT":
  ...
  return e.connect = function (e, t) {
    ...
    wn(r.observationTargets, t) < 0 && (a && Vt.push(r), r.observationTargets.push(new gn(t, n && n.box)), vn(1), hn.schedule());
  }, e.unobserve = function (e, t) {
    var n = Cn.get(e),
        r = wn(n.observationTargets, t),
        a = 1 === n.observationTargets.length;
    r >= 0 && (a && Vt.splice(Vt.indexOf(n), 1), n.observationTargets.splice(r, 1), vn(-1));
  ...
  return e.prototype.observe = function (e, t) {
    ...
    if (!Wt(e)) throw new TypeError("Failed to execute 'observe' on 'ResizeObserver': parameter 1 is not of type 'Element");
    bn.observe(this, e, t);
  }, e.prototype.unobserve = function (e) {
    if (0 === arguments.length) throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': 1 argument required, but only 0 present.");
    if (!Wt(e)) throw new TypeError("Failed to execute 'unobserve' on 'ResizeObserver': parameter 1 is not of type 'Element");
    bn.unobserve(this, e);
...
function xn(e) {
  ...
  return useEffect(function () {
    ...
    if (e.current) {
      var n = new (window.ResizeObserver || En)(function (e) {
        var t = _slicedToArray(e, 1)[0].contentRect;
        r !== t.height && a(t.height), s !== t.width && c(t.width);
      });
      n.observe(e.current), t = function () {
        n.disconnect();
      };
    }
...
function Nn() {
  var e = useState({}),
      ...
      n = t[0],
      r = t[1],
      a = useContext(jt).peopleAdapter;
  return useEffect(function () {
    var e = a.getMe().subscribe(r, function (e) {
...
function Pn(e) {
  var t = useState(In),
      ...
      a = n[1],
      i = useContext(jt),
      s = i && i.meetingsAdapter;
  return useEffect(function () {
    var t, n, r;

    if (e && s) {
      var i = s.createMeeting(e).pipe((r = function (e) {
        var t = e.ID;
        return s.getMeeting(t);
      }, function (e) {
        return new Observable(function (t) {
          var n, a;
          return a = e.subscribe(function (e) {
            t.next(e), n = e;
          }, function (e) {
            return t.error(e);
          }, function () {
            a = r(n).subscribe(function (e) {
              return t.next(e);
            }, function (e) {
              return t.error(e);
            }, function () {
        ...
        a(Tn(Tn({}, In), {}, {
          ...
          c = function () {
        var e;
        null !== (e = n) && void 0 !== e && e.ID && s.leavemeeting(n.ID);
      };

      window.addEventListener("beforeunload", c), t = function () {
        var e;
        null !== (e = n) && void 0 !== e && e.ID && s.leaveMeeting(n.ID), c && (window.removeEventListener("beforeunload", c), c = void 0), i.unsubscribe();
      };
    } else a(Tn({}, In)), t = void 0;
...
function Sn(e, t) {
  var n = useState([]),
      ...
      a = r[0],
      i = r[1],
      o = useContext(jt).membershipsAdapter;
  return useEffect(function () {
    var n = o.getMembersFromDestination(e, t).subscribe(function (e) {
      i(_toConsumableArray(e));
    }, function (e) {
      i([]), console.error(e.message);
    });
    return function () {
      n.unsubscribe();
    };
...
function jn(e) {
  var t = useState({}),
      ...
      r = n[0],
      a = n[1],
      i = useContext(jt).organizationsAdapter;
  return useEffect(function () {
    var t;

    if (e) {
      var n = i.getOrg(e).subscribe(function (e) {
        a(function (e) {
          for (var t = 1; t < arguments.length; t++) {
            var n = null != arguments[t] ? arguments[t] : {};
...
function Bn(e) {
  var t = useState({}),
      ...
      r = n[0],
      a = n[1],
      i = useContext(jt).peopleAdapter;
  return useEffect(function () {
    var t = i.getPerson(e).subscribe(function (e) {
      var t = function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var n = null != arguments[t] ? arguments[t] : {};
      ...
      Object.keys(Y).includes(t.status) && (t.status = Y[t.status]), a(t);
    }, function (e) {
      a({
        displayName: " "
      }), console.error(e.message);
...
function Vn(e, t) {
  var n = e.current;
  useEffect(function () {
    n && (t instanceof MediaStream ? n.srcObject = t : t && console.error("useStream: invalid media stream received", t));
  }, [n, t]);
}
...
function qn(e) {
  var t = e.className,
    ...
    return Math.floor(11 * Math.random()) + 1;
      ...
      u = _slicedToArray(l, 1)[0],
      m = useState(!1),
      p = _slicedToArray(m, 2),
      d = p[0],
      f = p[1],
      h = null == s ? void 0 : s.split(" ").map(function (e) {
    return e.charAt(0);
  }).slice(0, 2).join(""),
      v = Hn[c],
      g = c === Y.SELF,
    ...
    "avatar-self": g
      ...
      M = D[0],
      L = D[1],
      T = "".concat(L("placeholder"), " ").concat(L("placeholder"), "-").concat(u),
      I = L("status-".concat(c));
  return N.createElement("div", {
    className: M,
    style: a
    ...
    className: L("content")
  }, C && n && N.createElement(Rt, null), w && N.createElement("svg", {
    viewBox: "0 0 40 40",
    className: T
  }, N.createElement("text", {
    x: "50%",
    y: "50%"
  }, " " === s ? "??" : h)), b && N.createElement("img", {
    className: L(d ? "image-error" : "image"),
    src: o,
    alt: "avatar",
    onError: function () {
      return f(!0);
    ...
    className: L("status-icon-container")
  }, N.createElement(St, {
    name: v,
    className: "".concat(L("status-icon"), " ").concat(I)
  })), y && n && N.createElement("svg", {
    viewBox: "0 0 26 26",
    className: L("bot-badge")
  }, N.createElement("text", {
    x: "50%",
    y: "57%"
  }, "Bot")), g && n && N.createElement(St, {
    name: "chat-filled",
    className: L("self-icon")
  })));
}
...
var ir,
  ...
  formatDistance: function (e, t, n) {
    var r;
    return n = n || {}, r = "string" == typeof $n[e] ? $n[e] : 1 === t ? $n[e].one : $n[e].other.replace("{{count}}", t), n.addSuffix ? n.comparison > 0 ? "in " + r : r + " ago" : r;
  },
  formatLong: tr,
  ...
  match: {
    ordinalNumber: (ir = {
      ...
      var n = String(e),
          r = t || {},
          a = n.match(ir.matchPattern);
      if (!a) return null;
      var i = a[0],
          o = n.match(ir.parsePattern);
      if (!o) return null;
      var s = ir.valueCallback ? ir.valueCallback(o[0]) : o[0];
      return {
...
var lr = function (e, t) {
  var n = e.getUTCFullYear(),
      r = n > 0 ? n : 1 - n;
  return cr("yy" === t ? r % 100 : r, t.length);
},
    ur = function (e, t) {
  var n = e.getUTCMonth();
  return "M" === t ? String(n + 1) : cr(n + 1, 2);
},
    mr = function (e, t) {
  return cr(e.getUTCDate(), t.length);
},
    pr = function (e, t) {
  return cr(e.getUTCHours() % 12 || 12, t.length);
},
    dr = function (e, t) {
  return cr(e.getUTCHours(), t.length);
},
    fr = function (e, t) {
  return cr(e.getUTCMinutes(), t.length);
},
    hr = function (e, t) {
  return cr(e.getUTCSeconds(), t.length);
},
    vr = function (e, t) {
  var n = t.length,
      r = e.getUTCMilliseconds();
  return cr(Math.floor(r * Math.pow(10, n - 3)), t.length);
};
...
function wr(e, t) {
  ...
  var n = t || {},
      ...
      i = null == a ? 0 : Un(a),
      o = null == n.weekStartsOn ? i : Un(n.weekStartsOn);
...
function br(e, t) {
  ...
  var n = Fn(e, t),
      ...
      s = null == o ? 1 : Un(o),
      c = null == a.firstWeekContainsDate ? s : Un(a.firstWeekContainsDate);
  if (!(c >= 1 && c <= 7)) throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
  var l = new Date(0);
  l.setUTCFullYear(r + 1, 0, c), l.setUTCHours(0, 0, 0, 0);
  var u = wr(l, t),
      m = new Date(0);
  m.setUTCFullYear(r, 0, c), m.setUTCHours(0, 0, 0, 0);
  var p = wr(m, t);
...
function Er(e, t) {
  ...
  var n = t || {},
      ...
      i = null == a ? 1 : Un(a),
      o = null == n.firstWeekContainsDate ? i : Un(n.firstWeekContainsDate),
      s = br(e, t),
      c = new Date(0);
...
var xr = "midnight",
  ...
  Y: function (e, t, n, r) {
    var a = br(e, r),
        i = a > 0 ? a : 1 - a;
    return "YY" === t ? cr(i % 100, 2) : "Yo" === t ? n.ordinalNumber(i, {
      unit: "year"
    }) : cr(i, t.length);
  },
  R: function (e, t) {
    return cr(yr(e), t.length);
  },
  u: function (e, t) {
    return cr(e.getUTCFullYear(), t.length);
  },
  Q: function (e, t, n) {
  ...
  w: function (e, t, n, r) {
    var a = function (e, t) {
      Zn(1, arguments);
      var n = Fn(e),
          r = wr(n, t).getTime() - Er(n, t).getTime();
  ...
  b: function (e, t, n) {
    ...
    switch (r = 12 === a ? Nr : 0 === a ? xr : a / 12 >= 1 ? "pm" : "am", t) {
      case "b":
      case "bb":
      case "bbb":
        return n.dayPeriod(r, {
  ...
  B: function (e, t, n) {
    ...
    switch (r = a >= 17 ? Dr : a >= 12 ? Or : a >= 4 ? kr : Mr, t) {
      case "B":
      case "BB":
      case "BBB":
        return n.dayPeriod(r, {
  ...
  t: function (e, t, n, r) {
    ...
    return cr(Math.floor(a.getTime() / 1e3), t.length);
  },
  T: function (e, t, n, r) {
    return cr((r._originalDate || e).getTime(), t.length);
  }
};
...
function Ir(e, t) {
  return e % 60 == 0 ? (e > 0 ? "-" : "+") + cr(Math.abs(e) / 60, 2) : Pr(e, t);
}
...
function Pr(e, t) {
  var n = t || "",
      r = e > 0 ? "-" : "+",
      a = Math.abs(e);
  return r + cr(Math.floor(a / 60), 2) + n + cr(a % 60, 2);
}
...
var jr = {
  ...
  P: function (e, t) {
    ...
    return n.replace("{{date}}", Sr(a, t)).replace("{{time}}", Rr(i, t));
  }
},
    zr = ["D", "DD"],
    Ar = ["YY", "YYYY"];
...
function Br(e) {
  return -1 !== zr.indexOf(e);
}

function Vr(e) {
  return -1 !== Ar.indexOf(e);
}
...
var qr = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,
    Ur = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,
    Zr = /^'([^]*?)'?$/,
    Fr = /''/g,
    Wr = /[a-zA-Z]/;
...
function Yr(e, t, n) {
  ...
  var l = i.options && i.options.weekStartsOn,
      u = null == l ? 0 : Un(l),
      m = null == a.weekStartsOn ? u : Un(a.weekStartsOn);
  ...
  var d = Xn(p),
    ...
    _originalDate: p
      ...
      v = r.match(Ur).map(function (e) {
    var t = e[0];
    return "p" === t || "P" === t ? (0, jr[t])(e, i.formatLong, h) : e;
  }).join("").match(qr).map(function (n) {
    if ("''" === n) return "'";
    var r = n[0];
    if ("'" === r) return Gr(n);
    var o = Lr[r];
    if (o) return !a.useAdditionalWeekYearTokens && Vr(n) && Hr(n, t, e), !a.useAdditionalDayOfYearTokens && Br(n) && Hr(n, t, e), o(f, n, i.localize, h);
    if (r.match(Wr)) throw new RangeError("Format string contains an unescaped latin alphabet character `" + r + "`");
    return n;
  }).join("");
  return v;
}
...
function Gr(e) {
  return e.match(Zr)[1].replace(Fr, "'");
}

function ia(e) {
  var t = e.adapter,
      n = e.children;
  return N.createElement(jt.Provider, {
    value: t
  }, n);
}
...
function oa(e) {
  var t = e.children,
      ...
      r = e.style,
      a = e.type,
      i = Ie("banner", n, _defineProperty({}, "".concat(a), !0)),
      o = _slicedToArray(i, 1)[0];
  return N.createElement("div", {
    className: o,
    style: r
...
function ca(e) {
  ...
  return n && (o.width = n, o.height = n), N.createElement("div", {
    className: i,
    style: o
  });
}
...
function ma(e) {
  var t = e.children,
      ...
      r = e.style,
      a = e.type,
      i = Ie("title", n, _defineProperty({}, "".concat(a), !0)),
      o = _slicedToArray(i, 1)[0];
  return N.createElement("h5", {
    className: o,
    style: r
  }, t);
}
...
function pa(e) {
  var t = e.className,
      ...
      h = zn(),
      v = useContext(jt);
  Vn(p, o), Vn(d, s), Vn(f, c), function (e, t) {
    var n = e.current;
    useEffect(function () {
  ...
  var g,
    ...
    "desktop-xl": y >= 1440,
    "remote-video-n-share": s && c
  }),
      x = _slicedToArray(b, 2),
      k = x[0],
      M = x[1];
  return useEffect(function () {
    s && v.meetingsAdapter.changeLayout(r, n);
  }, [v.meetingsAdapter, n, r, s]), g = l ? N.createElement("div", {
    className: M("media-error")
  }, N.createElement(St, {
    name: "error",
    className: M("error-icon")
  }), N.createElement("div", null, "Having trouble joining the meeting?"), N.createElement("div", null, "Please check your connection.")) : w && C ? N.createElement(N.Fragment, null, s && N.createElement("video", {
    className: "".concat(M("video"), " ").concat(M("remote-video")),
    ref: d,
    muted: !0,
    playsInline: !0,
    autoPlay: !0
  }), c && N.createElement("video", {
    className: "".concat(M("video"), " ").concat(M("remote-share")),
    ref: f,
    muted: !0,
    playsInline: !0,
    autoPlay: !0
  }), o && N.createElement("audio", {
    ref: p,
    autoPlay: !0
  })) : w && !C ? N.createElement(ma, {
    type: "subsection"
  }, "Waiting for others to join...") : N.createElement(ua, {
    className: M("connecting-badge")
  }, N.createElement(ca, {
    size: 14,
    className: M("connecting-spinner")
  }), N.createElement("span", null, "Connecting")), N.createElement("div", {
    ref: h,
    className: k,
    style: a
  }, g);
...
function da(e) {
  var t = e.className,
      ...
      f = d[0],
      h = d[1],
      v = null != s && s.stream ? "screen" : "video",
      g = Ie("in-meeting", t, {
    tablet: u >= 768 && u < 1024,
    desktop: u >= 1024 && u < 1440,
    "desktop-xl": u >= 1440,
    "remote-sharing": null !== o
  }),
  ...
  return useEffect(function () {
    ...
    className: w("media-container")
  }, N.createElement(pa, {
    className: w("remote-media-in-meeting"),
    layout: n,
    meetingID: r
  }), N.createElement(la, {
    className: w("local-media-in-meeting"),
    meetingID: r,
    mediaType: v
  }), (null == s ? void 0 : s.stream) && N.createElement(oa, {
    className: w("share-banner")
...
function fa(e) {
  var t,
    ...
    desktop: f >= 1024
      ...
      g = v[0],
      y = v[1],
      C = N.createElement(ca, {
    size: 36
  });

  if (l) {
    var w = p || "No Meeting Information";
    C = N.createElement(N.Fragment, null, N.createElement("h2", {
      className: y("title")
    }, w), u && m && N.createElement("h3", {
      className: y("time")
...
function ha(e) {
  ...
  return useEffect(function () {
    ...
    meetingID: n,
    mediaType: "video"
  }), f.stream && N.createElement(oa, null, "My preview"))) : N.createElement(ca, null));
}
...
var Ca = function (e) {
  ...
  if (i) {
    ...
    t = {
      left: f.x + f.width / 2,
      bottom: window.innerHeight - f.top + 14 - window.scrollY
    };
  }
  ...
  return useEffect(function () {
    ...
    return e;
  }, [i]), p && N.createElement(va, null, N.createElement("div", {
    className: c,
    style: ya(ya({}, a), t)
  }, N.createElement("div", {
    className: l("wrapper")
...
function Ea(e) {
  var t,
      ...
      p = e.tooltip,
      f = e.type,
      h = Ie("button", i, (_defineProperty(t = {}, "".concat(f), !0), _defineProperty(t, "pressed", c), t)),
      v = _slicedToArray(h, 1)[0],
      g = zn();
  return At(g, r), N.createElement(N.Fragment, null, N.createElement("button", {
    className: v,
    disabled: o,
    type: "button",
    onClick: s,
...
function ka(e) {
  var t = e.className,
    ...
    error: l
      ...
      b = C[1],
      x = zn();
  return At(x, p), N.createElement("div", {
    className: v,
    style: n
  }, N.createElement("div", {
    ...
    tabIndex: d,
    ref: x
  }), "password" === r && i && N.createElement(Ea, {
    type: "ghost",
...
function Oa(e) {
  ...
  return N.createElement("div", {
    ...
    name: "arrow-left",
    size: "13"
  })), o && N.createElement("h3", {
    className: p("title")
  }, o), a && N.createElement(Ea, {
    tabIndex: 199,
    className: p("close"),
    type: "ghost",
    size: 28,
...
function Da(e) {
  ...
  }, i.icon && N.createElement(St, {
    name: i.icon
  }), N.createElement("span", {
    className: p("label")
  }, i.label), void 0 !== o && N.createElement(St, {
    className: Me(p("check"), _defineProperty({}, p("check--invisible"), o !== i.value)),
    size: 16,
    name: "check"
  }));
}
...
function La(e) {
  ...
  return useEffect(function () {
    ...
    onKeyDown: function (e) {
      "Enter" !== e.key && " " !== e.key || e.target !== e.currentTarget ? "Tab" === e.key ? w() : "ArrowDown" !== e.key && "ArrowUp" !== e.key || b(!0) : b(!0);
    },
    ref: C
  }, N.createElement("span", {
    className: g("label")
  }, null === a ? "Loading..." : y || r), N.createElement(St, {
    name: p ? "arrow-up" : "arrow-down",
    size: 13
  })), p && N.createElement(Ma, {
...
function Ia(e) {
  ...
  }, n), N.createElement(St, {
    name: o.icon,
    size: 48,
    ariaLabel: o.iconLabel
  }), N.createElement("h2", {
    className: u("title")
  }, o.title), N.createElement("p", {
    className: u("body")
  }, "Select", " ", N.createElement("span", {
    className: u("allow")
  }, "Allow"), " ", o.message), N.createElement(Ea, {
    type: "default",
    size: 40,
    onClick: function () {
...
function Sa(e) {
  var t,
    ...
    var n = useState({}),
        ...
        a = r[0],
        i = r[1],
        o = useContext(jt).meetingsAdapter.meetingControls,
        s = o[e];
    return useEffect(function () {
      s || console.error("".concat(e, ' control is not defined. Available controls are "').concat(Object.keys(o).join(", "), '".'));
    }, [e, o, s]), useEffect(function () {
      var e;

      if (s) {
        var n = s.display(t).subscribe(i);
  ...
  return t = p && 0 !== Object.keys(p).length ? "MULTISELECT" === p.type ? function (e, t, n, r, a) {
    var i = n.options,
        o = n.noOptionsMessage,
        s = n.selected,
        c = n.tooltip,
        l = n.hint;
    return N.createElement(La, {
      ...
      options: 0 === (null == i ? void 0 : i.length) ? [{
        value: "",
        label: o
      }] : i,
      disabled: !(null != i && i.length),
      tooltip: c,
      ariaLabel: l,
      tabIndex: a
    });
  }(v, m, p, s, c) : function (e, t, n, r, a, i, o, s) {
    var c = n.icon,
        l = n.type,
        u = n.text,
        m = n.tooltip,
    ...
    return i ? N.createElement(Ea, {
      ...
      name: c,
      size: 24
    }), (a || !c) && u && N.createElement("span", {
      className: e("button-text")
    }, u));
  }(v, m, p, s, o, n, r, c) : "", N.createElement("div", {
    className: h
  }, t);
}
...
function ja(e) {
  for (var t = e.className, n = e.collapseRangeStart, r = e.collapseRangeEnd, a = e.controls, i = e.meetingID, o = e.style, s = e.tabIndexes, c = useContext(jt).meetingsAdapter, l = Mn(i).state, u = zn(), m = zn(), p = zn(), d = xn(u).width, f = xn(p).width, h = l === H, v = Ie("meeting-control-bar", t), g = _slicedToArray(v, 2), y = g[0], C = g[1], w = a(h), b = s(h), M = w.length, L = useState(), T = _slicedToArray(L, 2), I = T[0], P = T[1], S = useState([0, 0]), R = _slicedToArray(S, 2), j = _slicedToArray(R[0], 2), z = j[0], A = j[1], B = R[1], V = useState(void 0), q = _slicedToArray(V, 2), U = q[0], Z = q[1], F = [], W = [], Y = [], G = [], _ = 0; _ < 20; _ += 1) {
    var X = zn(),
        K = zn(),
        J = xn(X).width,
        Q = xn(K).width,
  ...
  useEffect(function () {
    if (Y.splice(M), G.splice(M), d && f && Y.every(Ra) && G.every(Ra)) {
  ...
  var te,
    ...
    return function (e, t) {
      ...
      return N.createElement(Sa, {
        ...
        meetingID: i,
        showText: I[e],
        autoFocus: b[e] === Math.min.apply(Math, _toConsumableArray(b)) || !1,
        tabIndex: b[e]
      });
    });
  },
  ...
  return useEffect(function () {
    ...
    var t;
  }, m, b[z]), ne(A, M)), N.createElement("div", {
...
ja.propTypes = {
  ...
  collapseRangeEnd: -1,
  controls: function (e) {
    return e ? ["mute-audio", "mute-video", "leave-meeting"] : ["mute-audio", "mute-video", "join-meeting"];
  },
  tabIndexes: function (e) {
    return e ? [1, 2, 3] : [2, 3, 1];
  },
  style: void 0
};
var za = "Webex by Cisco logo",
    Aa = "Your name appears in the participant list. Skip this optional field to use the name provided by the system.",
    Ba = "The password is provided in the invitation for a scheduled  meeting, or from the host.",
    Va = "Start meeting. Start the meeting after entering the required information.",
    Ha = "Click to go to a new screen where the meeting host can enter the host key.";

function qa(e) {
  var t = e.className,
      n = e.meetingID,
      r = e.style,
      a = e.switchToHostModal,
      i = useState(),
      o = _slicedToArray(i, 2),
      s = o[0],
      c = o[1],
      ...
      C = g.invalidPassword,
      w = useState(!1),
      b = _slicedToArray(w, 2),
      x = b[0],
      D = b[1],
      M = useContext(jt),
      L = zn(),
      T = Ie("meeting-guest-authentication", t, {
    phone: xn(L).width <= 425
  }),
  ...
  return N.createElement("div", {
    ...
    onChange: function (e) {
      c(e), v(function (e) {
        var t;
        return e.match(/^[a-zA-Z ]*$/) || (t = "Name can only contain letters."), t;
      }(e));
    },
    disabled: x,
    error: h,
    ...
    className: S("label-text")
  }, "Meeting password (required)"), N.createElement(ka, {
    type: "password",
    name: "password",
    value: m,
    onChange: function (e) {
      p(e), M.meetingsAdapter.clearInvalidPasswordFlag(y);
    },
    disabled: x,
    ...
    ariaLabel: Va,
    tabIndex: 103
  }, x && N.createElement(ca, {
    className: S("start-button-spinner"),
    size: 16
  }), x ? "Starting meeting..." : "Start meeting")), N.createElement("div", {
    className: S("host-text")
  }, "Hosting the meeting?", " ", N.createElement("a", {
    href: "#",
    tabIndex: 104,
...
var Ua = "Webex by Cisco logo",
    Za = "The host key is generated when a meeting is scheduled.",
    Fa = "Start meeting. Start the meeting for all participants after entering the required information.";
...
function Wa(e) {
  var t = e.className,
      ...
      h = useContext(jt),
      v = zn(),
      g = Ie("meeting-host-authentication", t, {
    phone: xn(v).width <= 425
  }),
      y = _slicedToArray(g, 2),
      C = y[0],
      w = y[1],
      b = !o || u || d,
      x = "Enter host information to join";
  return N.createElement("div", {
    ref: v,
    className: C,
    style: r
  ...
  }, "Host key (required)"), N.createElement(ka, {
    type: "password",
    name: "password",
    value: o,
    disabled: d,
...
function Ya(e) {
  var t,
    ...
    return e.ID === o;
      ...
      w = p.ID === o && a === Z,
      b = null == d ? void 0 : d.host,
      x = null == d ? void 0 : d.guest,
      k = [w && "You", b && "Host", y && "Presenter"].filter(function (e) {
    return e;
  }),
      O = (null == m || null === (t = m[0]) || void 0 === t ? void 0 : t.split("@")[1]) || N.createElement("i", null, "Unknown organization"),
      D = Ie("member", n),
  ...
  return N.createElement("div", {
    ...
    className: T("name")
  }, (null != l ? l : N.createElement(ca, {
    size: 16
  })) || N.createElement("i", null, "Name not available"), x && N.createElement("span", {
    className: T("guest")
  }, " (Guest)")), k.length > 0 && N.createElement("div", {
    className: T("roles")
  }, k.join(", ")), g && N.createElement("div", {
    className: T("organization")
  }, f.name || O)), C && y && N.createElement(St, {
    name: "content-share",
    size: 16,
    className: T("sharing")
  }), C && v && N.createElement(St, {
    name: "microphone",
    size: 16,
    className: T("speaking")
  }), C && h && N.createElement(St, {
...
function Ga(e) {
  var t = e.className,
    ...
    return e.map(function (e) {
      ...
      d = function (e, t) {
    return e.length > 0 && N.createElement(N.Fragment, null, N.createElement("h5", {
  ...
  return N.createElement("div", {
    ...
    type: "section",
    className: m("title")
  }, "Participants (", o ? o.length : N.createElement("i", null, "loading..."), ")"), N.createElement(Ea, {
    type: "ghost",
    size: 28,
    onClick: i,
    tabIndex: 50,
    ...
    className: m("members")
  }, r !== Z ? p(o) : N.createElement(N.Fragment, null, d(o.filter(function (e) {
    return e.inMeeting;
...
function _a(e) {
  ...
  return N.createElement("div", {
    ...
    return N.createElement("li", {
      className: Me(m("tab"), r === e.key && m("tab--active")),
      key: e.key,
      role: "tab",
...
var Xa = Ie("no-media"),
    Ka = _slicedToArray(Xa, 2)[1],
    Ja = {
  microphone: {
    icon: "microphone-issue",
    title: "Can't access microphone",
    message: N.createElement(N.Fragment, null, N.createElement("p", {
      className: Ka("indications")
    }, "Reload this page and select ", N.createElement("b", {
      className: Ka("accent")
    }, "Allow"), " when your browser asks."), N.createElement("p", {
      className: Ka("indications")
    }, N.createElement("div", null, N.createElement("b", {
      className: Ka("accent")
    }, "Still not working?")), "You may need to update your webpage permissions. Go to your ", N.createElement("b", {
      className: Ka("accent")
    }, "browser settings"), ", look for website settings, select ", N.createElement("b", {
      className: Ka("accent")
...
function Qa(e) {
  ...
  return N.createElement("div", {
    ...
    className: Ka("icon-media-issue"),
    name: o.icon
  }), N.createElement(ma, {
    type: "subsection",
    className: Ka("title")
  }, o.title), N.createElement("div", {
    className: Ka("body")
  }, o.message));
}
...
function $a(e) {
  var t = e.className,
      n = e.meetingID,
      r = e.style,
      a = Ie("audio-settings", t),
      i = _slicedToArray(a, 2),
      o = i[0],
      s = i[1],
      c = Mn(n).localAudio.permission;
  return N.createElement("div", {
    className: o,
    style: r
  }, "DENIED" === c || "DISMISSED" === c || "IGNORED" === c ? N.createElement(Qa, {
    media: "microphone",
    className: s("no-media")
  }) : N.createElement(N.Fragment, null, N.createElement(ma, {
    type: "subsection"
  }, "Speaker"), N.createElement(Sa, {
    type: "switch-speaker",
    meetingID: n,
    tabIndex: 102
  }), N.createElement(ma, {
    type: "subsection"
  }, "Microphone"), N.createElement(Sa, {
...
function ei(e) {
  var t = e.meetingID,
      n = e.className,
      r = e.style,
      a = Ie("video-settings", n),
      i = _slicedToArray(a, 2),
      o = i[0],
      s = i[1],
      c = Mn(t).localVideo.permission;
  return N.createElement("div", {
    className: o,
    style: r
  }, "DENIED" === c || "DISMISSED" === c || "IGNORED" === c ? N.createElement(Qa, {
...
function ni(e) {
  ...
  return N.createElement("div", {
    ...
    className: s("text")
  }, "Thank you for waiting. We’ll start the meeting when the host joins."), N.createElement(Ea, {
    type: "default",
    size: 40,
    onClick: function () {
    ...
    tabIndex: 1
  }, "Leave meeting")), N.createElement(la, {
...
function ri(e) {
  var t = e.className,
      ...
      a = e.controlsCollapseRangeEnd,
      i = e.controlsTabIndexes,
      o = e.layout,
      s = e.logo,
      c = e.meetingID,
      l = e.style,
    ...
    "roster-only": h && M <= 425
      ...
      A = zn(),
      B = useState("guest"),
      U = _slicedToArray(B, 2),
      F = U[0],
      W = U[1];
  useEffect(function () {
    return f && f !== w && (z(!0), A.current = setTimeout(function () {
      z(!1);
    }, 3e3)), function () {
      return clearTimeout(A.current);
    };
  }, [p.stream, d.stream, f, w]);
  var Y,
      G = "".concat(p.stream ? "Unmuted" : "Muted", ", ").concat(d.stream ? "Camera on" : "Camera off");
  if (f) {
    if (f === w) Y = N.createElement(ma, {
      type: "subsection",
      className: P("centered")
    }, "You've successfully left the meeting");else {
      var _;

      _ = f === y ? da : f === C ? ha : ni, Y = N.createElement(N.Fragment, null, N.createElement("div", {
        className: P("body")
      }, N.createElement(_, {
        meetingID: m,
        className: P("inner-meeting"),
        layout: o
      }), h && N.createElement(Ga, {
        destinationID: m,
        destinationType: Z,
        className: P("member-roster"),
        onClose: function () {
          return b.meetingsAdapter.toggleRoster(m);
        }
      }), j && N.createElement(ua, {
        className: P("media-state-toast")
      }, G)), N.createElement(ja, {
        meetingID: m,
        className: P("control-bar"),
        controls: n,
        collapseRangeStart: r,
        collapseRangeEnd: a,
        tabIndexes: i
      }), v.visible && N.createElement(Oa, {
        onClose: function () {
          return b.meetingsAdapter.toggleSettings(m);
        },
        otherClassName: P("settings"),
        title: "Settings",
        ariaLabel: "Meeting settings window"
      }, N.createElement(ti, {
        meetingID: m
      })), g && f === C && N.createElement(Oa, {
        onClose: function () {
          return b.meetingsAdapter.clearPasswordRequiredFlag(m);
        },
        otherClassName: [P("authentication")],
        onBack: "host" === F && function () {
          return W("guest");
        },
        ariaLabel: "guest" === F ? "Meeting guest authentication" : "Meeting host authentication"
      }, "guest" === F ? N.createElement(qa, {
        meetingID: m,
        className: P("authentication-guest"),
        switchToHostModal: function () {
          return W("host");
        }
      }) : N.createElement(Wa, {
        meetingID: m,
        className: P("authentication-host")
      })));
    }
  } else Y = N.createElement("div", {
    className: P("loading-logo")
  });
  return N.createElement("div", {
    className: I,
    style: l,
...
function ai(e) {
  function t(t) {
    var n = Pn(t.meetingDestination);
    return N.createElement(e, _extends({
      meeting: n
    }, t));
  }
...
function si(e, t) {
  function n(n) {
    ...
    useEffect(function () {
      ...
      function t() {
        return (t = _asyncToGenerator(regenerator.mark(function e() {
          return regenerator.wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return e.next = 2, l.connect();

              case 2:
                global.testRendererAct(function () {
                  return o(!0);
                });
      ...
      function n() {
        return (n = _asyncToGenerator(regenerator.mark(function e() {
          return regenerator.wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
                return o(!1), e.next = 3, l.disconnect();
    ...
    var d = oi(oi({}, n), {}, {
      adapterConnected: i
        ...
        f = N.createElement(e, d);
    return i ? N.createElement(ia, {
      adapter: l
    }, f) : f;
  }
...
Qa.propTypes = {
  ...
  controlsTabIndexes: function (e) {
    return e ? [1, 2, 3, 4, 5, 6] : [2, 3, 4, 1];
  },
  layout: void 0,
  logo: void 0,
  meetingID: void 0,
...
function WebexLogo() {
  return /*#__PURE__*/N.createElement("svg", {
    ...
    offset: "1",
    stopColor: "#00BBFF"
  })), /*#__PURE__*/N.createElement("radialGradient", {
    id: "paint1_radial",
    cx: "0",
    cy: "0",
    r: "1",
...
var WebexMeetingsWidget = /*#__PURE__*/function (_Component) {
  ...
  _createClass(WebexMeetingsWidget, [{
    ...
    value: function render() {
      ...
      var logo = /*#__PURE__*/N.createElement(WebexLogo, null);
      var contentClass = 'webex-meetings-widget__content';
      var content;

      if (audioPermission === 'ASKING') {
        content = /*#__PURE__*/N.createElement(Ia, {
        ...
        content = /*#__PURE__*/N.createElement(ri, {
          meetingID: meeting.ID,
          logo: logo,
...
var WebexMeetings = si(ai(WebexMeetingsWidget), function (props) {
  var webex = new Webex({
    credentials: {
